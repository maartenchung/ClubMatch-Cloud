/* ClubMatch Cloud v0.8 - central team/season/player management */
(function(global){
'use strict';
...
function createManagementController(options={}){
  const client=options.client;invariant(client?.rpc,'Cloud-client met RPC is verplicht');let teamSeasons=[],admin=null,teamSeasonId='';
  function state(){return Object.freeze({teamSeasons:Object.freeze([...teamSeasons]),teamSeasonId,admin:admin?Object.freeze({...admin,players:Object.freeze([...(admin.players||[])].map(p=>Object.freeze({...p,preferred_positions:Object.freeze([...(p.preferred_positions||[])] )}))}):null})}
  ...
  return Object.freeze({loadTeamSeasons,load,updateNames,savePlayer,addPlayer,get state(){return state()},normalizePositions:positions})
}
