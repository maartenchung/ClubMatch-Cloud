...
let client=null,runtime=null,renderer=null,lifecycleSync=null,lastFrame=null,busy=false;
...
function bindActions(){
  ...
  byId('refreshMatchesBtn').onclick=()=>run('Wedstrijden verversen',refreshOpenMatches);byId('refreshLiveBtn').onclick=()=>run('Live status verversen',()=>runtime.refresh('manual'));
